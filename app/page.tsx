...
export default function Home(){
  return <main className="landing-page">
    <header className="landing-header">
      <a href="/" className="landing-brand"><span>✧</span> <b>AstraLoom</b></a>
      <nav aria-label="Main navigation"><a href="/about">About</a><a href="/services">Services</a><a href="#how-it-works">How it works</a><a className="landing-nav-cta" href="/">Start a consultation</a><ThemeToggle/></nav>
    </header>
    <section className="landing-hero">
      <div className="landing-hero-copy"><p className="landing-kicker">PERSONAL ASTROLOGY CONSULTATIONS</p><h1>Clarity for the<br/><em>next chapter.</em></h1><p className="landing-lede">AstraLoom combines a precise birth chart with a focused, question-led consultation—helping you look at the moment in front of you with more perspective.</p><div className="landing-trust"><span>✦ Private & personal</span><span>◌ $10 per question</span><span>⌁ Chart-led guidance</span></div><div className="landing-actions"><a className="landing-primary" href="/studio/">Create your chart <b>→</b></a><a className="landing-secondary" href="/services">Explore consultations</a></div></div>
    ...
    <section className="landing-final"><p className="landing-kicker">BEGIN WITH YOUR CHART</p><h2>Your question deserves a closer look.</h2><p>Create a chart now, save it to your profile, and prepare the context for a focused consultation.</p><a className="landing-final-cta" href="/studio/">Open AstraLoom <b>→</b></a></section>
    <footer className="landing-footer"><span>✧ AstraLoom</span><span>Personal astrology workspace and consultations.</span><a href="/studio/">Open workspace →</a></footer>
  </main>;
}
