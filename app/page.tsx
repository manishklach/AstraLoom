...
export default function Home(){
  return <main className="landing-page">
    <header className="landing-header">
      ...
      <nav aria-label="Main navigation"><Link href="/about">About</Link><Link href="/services">Services</Link><a href="#how-it-works">How it works</a><Link className="landing-nav-cta" href="/">Start a consultation</Link><ThemeToggle/></nav>
    </header>
