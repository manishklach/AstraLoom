...
export default function ServicesPage() {
  return <main className="service-page">
    ...
    <section className="service-offer"><div><p className="landing-kicker">A SIMPLE CONSULTATION</p><h2>$10 per focused question.</h2><p>Your question is considered alongside your birth chart, current transits, and relevant planetary periods. Start by preparing and saving a chart, then keep the question as specific as you can.</p><ul><li>Personal birth-chart context</li><li>Current transit and timing perspective</li><li>One defined question at a time</li></ul></div><aside><span>ONE QUESTION</span><strong>$10</strong><p>A focused astrology perspective for the decision or theme in front of you.</p><a href="/studio/">Prepare my chart →</a></aside></section>
    ...
    <section className="landing-final service-final"><p className="landing-kicker">START WITH A CHART</p><h2>Bring your question into focus.</h2><p>Create and save your chart first. It takes only a few minutes and gives your consultation the context it needs.</p><a className="landing-final-cta" href="/studio/">Open AstraLoom <b>→</b></a></section>
